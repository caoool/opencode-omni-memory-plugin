...
- For every substantive task, load the `markdown-memory` skill at orientation, use relevant memory silently, and follow its precedence, retention, transition-update, concurrency, and handoff rules.
